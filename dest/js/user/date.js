...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        var initY=parseInt((nowdate.getFullYear()))-1980;
        ...
        $.fn.date.defaultOptions = {
            cyear:nowdate.getFullYear(),    //默认选中年,20160703 yinyuanyuan add
            cmonth:parseInt(nowdate.getMonth()+"")+1,    //默认选中月,20160703 yinyuanyuan add
            cday:parseInt(nowdate.getDate()+""),    //默认选中日,20160703 yinyuanyuan add
            beginyear:1980,                 //日期--年--份开始
            endyear:nowdate.getFullYear()+20,                   //日期--年--份结束
	...
	function resetIndex(){
        ...
        function resetInitDete(){
            ...
            else if(that.val()==="" || opts.cyear!=null){
                initY=parseInt(opts.cyear)-opts.beginyear;//20160703 yinyuanyuan add
                initM=parseInt(opts.cmonth);//20160703 yinyuanyuan add
                initD=parseInt(opts.cday);//20160703 yinyuanyuan add
                return false;
            }
            ...
            var strM = $("#monthwrapper ul li:eq("+indexM+")").html().substr(0,$("#monthwrapper ul li:eq("+indexM+")").html().length-1);
              yearScroll = new iScroll("yearwrapper",{snap:"li",vScrollbar:false,
                  onScrollEnd:function () {
                   ...
                   strY = $("#yearwrapper ul li:eq("+indexY+")").html().substr(0,$("#yearwrapper ul li:eq("+indexY+")").html().length-1); //尹园园2016-7-28
                   strM = $("#monthwrapper ul li:eq("+indexM+")").html().substr(0,$("#monthwrapper ul li:eq("+indexM+")").html().length-1);//尹园园2016-7-28
